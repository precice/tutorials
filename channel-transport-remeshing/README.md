---
title: Channel transport remeshing
permalink: tutorials-channel-transport-remeshing.html
keywords: volume coupling, chemistry, OpenFOAM, Nutils, species, transport, remeshing
summary: A CFD problem is coupled to a transport (of, e.g., a chemistry species) in a uni-directional way with remeshing.
---

{% note %}
Get the [case files of this tutorial](https://github.com/precice/tutorials/tree/master/channel-transport-remeshing). Read how in the [tutorials introduction](https://precice.org/tutorials.html).
{% endnote %}
...
* Nutils without remeshing for reference. For more information, have a look at the [Nutils adapter documentation](https://precice.org/adapter-nutils.html). This Nutils solver requires at least Nutils v7.0.

* Nutils with remeshing. For more information, have a look at the [Nutils adapter documentation](https://precice.org/adapter-nutils.html). This Nutils solver requires at least Nutils v7.0.
