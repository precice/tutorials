...
You may find step-by-step instructions for each case in the [preCICE wiki](https://github.com/precice/tutorials/wiki). *More tutorials come with each adapter* and you can also find them in the wiki.
