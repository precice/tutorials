...
temperature_out = File("out_non_uniform/%s.pvd" % solver_name)
ref_out = File("out_non_uniform/ref%s.pvd" % solver_name)
error_out = File("out_non_uniform/error%s.pvd" % solver_name)
